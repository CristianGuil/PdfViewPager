...
public class RemotePDFViewPager extends MyViewPager implements DownloadFile.Listener {
    ...
    public RemotePDFViewPager(Context context, String pdfUrl, String namePdf, DownloadFile.Listener listener) {
        super(context);
